...
/**
 * in some screens with tables, this will be set for offsetHeader for table header
 */
export const tableHeaderOffset = 55;
...
export const COLUMN_CONFIG_TYPE = {
  ...
  COLUMN_INVENTORY_SKU_7: "column_inventory_sku_7",
  COLUMN_PO: "column_po",
